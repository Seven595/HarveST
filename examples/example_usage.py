...
def main():
    ...
    matrix_dir = "/data2/fanruibo/xiaobao/ST/sup/results_151674_1"  # Directory with preprocessed matrices
    
    original_data_path = "/data2/fanruibo/xiaobao/ST/Data/151674/"  # Original Visium data
